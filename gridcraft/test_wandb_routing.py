...
def test_mambpo_imagination_metrics_route_to_marl_training():
    routed = route_benchmarl_metrics(
        {
            ...
            "mambpo/imagined_batch_size": 0.0,
            "mambpo/imagination_used_for_training": 0.0,
    ...
    assert routed["MARL Training/imagined_batch_size"] == 0.0
    assert routed["MARL Training/imagination_used_for_training"] == 0.0
