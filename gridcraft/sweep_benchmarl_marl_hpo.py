...
ENV_OVERRIDES = {
    ...
    "model_type": ("MARL_HPO_MODEL", str),
    "hidden_size": ("MARL_HPO_HIDDEN_SIZE", int),
    "lstm_layers": ("MARL_HPO_LSTM_LAYERS", int),
    "lstm_dropout": ("MARL_HPO_LSTM_DROPOUT", float),
...
def main() -> None:
    ...
    selected_config = {
        ...
        "model_type": cfg_value("model_type", "lstm"),
        ...
        "lstm_layers": cfg_value("lstm_layers", 1),
        "lstm_dropout": cfg_value("lstm_dropout", 0.0),
    ...
    runner_args = [
        ...
        "--marl-model", str(selected_config["model_type"]),
        "--marl-hidden-size", str(selected_config["hidden_size"]),
        "--marl-lstm-layers", str(selected_config["lstm_layers"]),
        "--marl-lstm-dropout", str(selected_config["lstm_dropout"]),
